...
The Web SDK is hosted on your deployment at `/sdk-js/CobrowseIO.mjs`

You can use our snippet found on the [Web SDK](../../sdk-installation/web.md#installation) installation page, but replace the `src` that is set to `https://js.cobrowse.io/CobrowseIO.mjs` with your own deployment URL. For example if your deployment is running at `https://cobrowse.example.com`, the SDK will be hosted at `https://cobrowse.example.com/sdk-js/CobrowseIO.mjs`.
