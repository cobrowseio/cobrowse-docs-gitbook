...
**Note:** this guide will use our default UI to display the code. You can replace it with your own UI if you prefer! Please see [Customize the interface](https://app.gitbook.com/@cobrowseio/s/cobrowse-io-docs/~/drafts/-M9okd5FJNvKME4FOvYX/v/master/sdk-features/customize-the-interface).
