...
You may use either Windows Forms, or WPF in your application, so Cobrowse.io Windows SDK does not provide default UI for generating 6 digit code. You can generate a code for your UI by using the `CreateSession` API:
